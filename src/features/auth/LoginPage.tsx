            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full pl-11 pr-12 py-3 bg-surface-container-lowest border border-outline-variant rounded-xl text-sm focus:border-primary focus:ring-2 focus:ring-primary-muted transition-all"
                />
                <button
                  type="button"
